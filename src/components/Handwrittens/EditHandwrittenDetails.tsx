      ...
      {handwritten &&
        <>
          ...
          <form className="edit-handwritten-details" onSubmit={(e) => saveChanges(e)} onChange={() => setChangesSaved(false)}>
            ...
            <Grid>
              <GridItem colSpan={4} variant={['low-opacity-bg']}>
              ...
              <GridItem colSpan={4} variant={['low-opacity-bg']} className="no-print">
                <CreditCardBlock
                  handwritten={handwritten}
              ...
              <GridItem colSpan={2} variant={['no-style']} style={{ marginTop: '1rem' }}>
