...
import { reportArielSales } from "@/scripts/services/reportsService";
...
export default function ArielSalesDialog({ open, setOpen, openTable, setTableData, setReportsOpen }: Props) {
