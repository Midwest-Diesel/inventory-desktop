...
import { reportAllParts } from "@/scripts/controllers/reportsController";
...
export default function AllPartsDialog({ open, setOpen, setTableOpen, setTableData, setReportsOpen }: Props) {
