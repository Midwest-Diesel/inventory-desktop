...
import { reportAllSalesmen } from "@/scripts/services/reportsService";
...
export default function AllSalesmenDialog({ open, setOpen, openTable, setTableData, setReportsOpen }: Props) {
