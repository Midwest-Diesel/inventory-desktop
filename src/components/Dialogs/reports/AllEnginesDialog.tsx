...
import { reportAllEngines } from "@/scripts/controllers/reportsController";
...
export default function AllEnginesDialog({ open, setOpen, setTableOpen, setTableData, setReportsOpen }: Props) {
