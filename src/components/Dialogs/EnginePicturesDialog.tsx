...
export default function EnginePicturesDialog({ open, setOpen, pictures = [], stockNum }: Props) {
  const [selectedImages, setSelectedImages] = useState<string[]>([]);
  const DIRECTORY = `\\\\MWD1-SERVER\\Server\\Engines Pictures\\StockPhotos\\${stockNum}`;
