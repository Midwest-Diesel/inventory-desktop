...
import { formatCurrency, formatDate, formatPercent, serializeWeightDims } from "@/scripts/tools/stringUtils";
...
export default function PartDetails() {
  ...
  const onClickPrintInjTag = async () => {
    ...
    for (let i = 0; i < copies; i++) {
      ...
      addToQue('injPartTag', 'print_inj_part_tag', args, '300px', '350px');
    }
    printQue();
  };
                ...
                <Table variant={['plain', 'row-details']}>
                  <tbody>
                    <tr>
                      ...
                      <td style={{ whiteSpace: 'pre-line' }}>{ serializeWeightDims(part.weightDims) }</td>
                    </tr>
                  </tbody>
                </Table>
              </GridItem>
