...
import { addMapLocation, deleteMapLocation, editMapLocation, fixMapLocation, getBrokenLocations, getGeoLocation, getMapLocations, getMapNewLeads, getMapTopCustomers } from "@/scripts/controllers/mapController";
