...
-- ADD ONS
INSERT INTO "addOns" ("qty", "partNum", "desc", "stockNum", "location", "remarks", "entryDate", "rating", "engineNum", "condition", "purchasePrice", "purchasedFrom", "po", "manufacturer", "isSpecialCost", "type", "hp", "serialNum", "newPrice", "remanPrice", "dealerPrice", "priceStatus", "altParts", "isPrinted", "isPoOpened", "prefix")
VALUES
